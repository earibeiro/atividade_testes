...
import br.edu.ifpr.teste.servico.irpf.CalculadoraIRPF;
...
public class IRPFTest {
    ...
    public void testRendaIsenta() {
        ...
        assertEquals(BigDecimal.ZERO, imposto, "Renda de R$ 1.000,00 deve ser isenta");
    }
    ...
    public void testRendaSegundaFaixa() {
        ...
        assertEquals("Imposto para renda de R$ 3.000,00 deve ser R$ 95,20", 
                   impostoEsperado, imposto);
    }
    ...
    public void testRendaTerceiraFaixa() {
        ...
        assertEquals("Imposto para renda de R$ 4.000,00 deve ser R$ 263,87", 
                   impostoEsperado, imposto);
    }
    ...
    public void testRendaQuartaFaixa() {
        ...
        assertEquals("Imposto para renda de R$ 7.000,00 deve ser R$ 1.055,64", 
                   impostoEsperado, imposto);
    }
    ...
    public void testRendaNoLimiteIsencao() {
        ...
        assertEquals("Renda de R$ 1.903,98 deve ser isenta", BigDecimal.ZERO, imposto);
    }
    ...
    public void testRendaNoLimiteInferiorPrimeiraFaixa() {
        ...
        assertEquals("Imposto para renda de R$ 1.903,99 deve ser R$ 0,00", 
                   impostoEsperado, imposto);
    }
    ...
    public void testRendaNoLimiteSuperiorPrimeiraFaixa() {
        ...
        assertEquals("Imposto para renda de R$ 2.826,65 deve ser R$ 69,20", 
                   impostoEsperado, imposto);
    }
    ...
    public void testRendaNoLimiteInferiorSegundaFaixa() {
        ...
        assertEquals("Imposto para renda de R$ 2.826,66 deve ser R$ 69,20", 
                   impostoEsperado, imposto);
    }
    ...
    public void testRendaNoLimiteSuperiorSegundaFaixa() {
        ...
        assertEquals("Imposto para renda de R$ 3.751,05 deve ser R$ 207,86", 
                   impostoEsperado, imposto);
    }
    ...
    public void testRendaNoLimiteInferiorTerceiraFaixa() {
        ...
        assertEquals("Imposto para renda de R$ 3.751,06 deve ser R$ 207,86", 
                   impostoEsperado, imposto);
    }
    ...
    public void testRendaNoLimiteSuperiorTerceiraFaixa() {
        ...
        assertEquals("Imposto para renda de R$ 4.664,68 deve ser R$ 413,43", 
                   impostoEsperado, imposto);
    }
    ...
    public void testRendaNoLimiteInferiorQuartaFaixa() {
        ...
        assertEquals("Imposto para renda de R$ 4.664,69 deve ser R$ 413,43", 
                   impostoEsperado, imposto);
    }
    ...
    public void testRendaZero() {
        ...
        assertEquals("Renda de R$ 0,00 deve ser isenta", BigDecimal.ZERO, imposto);
    }
}